...
class Bazel < Formula
  ...
  url "https://releases.bazel.build/0.19.1/release/bazel-0.19.1-installer-darwin-x86_64.sh", using: :nounzip
  version '0.19.1'
  sha256 'e2812cd69483b993a0ca1ab13771f7667645b99e41ee007265cf65c681b568da'
