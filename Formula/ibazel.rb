...
class Ibazel < Formula
  ...
  url "https://github.com/bazelbuild/bazel-watcher/archive/v0.9.1.tar.gz"
  
  # To generate run:
  # curl https://codeload.github.com/bazelbuild/bazel-watcher/tar.gz/v0.9.1 | sha256sum
  sha256 '59eeb0fdbc0567de12aa46ef6a63bf10f109b08e52fc83995a446409f0b7faab'
